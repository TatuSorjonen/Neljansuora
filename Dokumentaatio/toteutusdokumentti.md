...
Tässä vielä viivadiagrammit. Aika on kerrottu 10 000:lla.

![](./kuvat/minimax_alpha_beta_ei_heuristiikkaa.png)

![](./kuvat/minimax_alpha_beta_heuristiikalla.png)

![](./kuvat/minimax_heuristiikka_ei_alpha_beta.png)

Testeistä huomataan kuinka paljon hyvin pelaavan heuristiikka funktion lisääminen vaikuttaa negatiivisesti buustatun minimaxin nopeuteen. Tämä johtuu nimittäin alpha-beta pruningista. Kokeilin nimittäin vaihtaa heuristiikka funktiota ja minimax toimi edelleen samalla tavalla, mutta pruning oli hitaampi tai nopeampi riippuen muutoksista.
...
Olisin saanut ohjelman nopeammaksi hyvin helposti, mutta silloin täkoäly olisi pelannut heikommin. Heikommin pelaamista ei kyllä välttämättä olisi huomannut muut. Itse kyllä huomasin, sillä olen pelannut peliä paljon vuosien varrella. Huonosti pelaaminen häiritsi paljon ja päätin jättää paremmin pelaavan version loppupalautukseen, vaikka toimi hitaammin. Demotilaisuuden aikana tajusin oman ohjelmani olevan liian hidas verrattuna muihin neljänsuora töihin. Lisäsin työhön kymmenen tarkkudella pyörityksen heuristiikan pisteisiin. Tämä nopeutti ohjelmaa, mutta heikensi peliä minun silmiini jonkin verran. Tämä on myös loogista, sillä nyt ei käydä niin montaa mahdollista asemaa läpi, sillä jotkin asemat saavat nyt samoja arvoja. Kuitenkin edelleen tekoäly pelaa todella hyvin. Voisin ihan hyvin pyöristää pisteet satoihin ja luultavasti olisi todella paljon nopeampi, mutta pelaisi huomattavasti heikommalla tasolla.
